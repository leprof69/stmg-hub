...
export const SDGN_CHAP5_EXERCISES: SdgnMissionExercise[] = [
  {
    id: "sdgn5-e1",
    ...
    xp: 120,
    minChars: 120,
    support: "Chaque année, Michelin organise un entretien professionnel obligatoire : bilan des objectifs atteints, fixation de nouveaux indicateurs, discussion formations (sécurité, nouveaux outils), évolution de carrière possible, retour sur ergonomie des postes. Le salarié peut préparer une auto-évaluation. Le manager admet que l'évaluation reste partiellement subjective, d'où l'intérêt du dialogue.",
    consigne: "Liste les finalités de l'évaluation de l'activité de travail selon le manuel et illustre avec le support Michelin.",
    questions: [
  ...
  },
  {
    ...
    xp: 130,
    minChars: 140,
    support: "Lors de l'entretien annuel chez Bouygues Telecom, Amina estime avoir dépassé ses objectifs commerciaux de 8 %. Son manager retient 5 % et note « marge de progression ». Amina perçoit un biais. Le RH propose un entretien de recadrage avec grille d'évaluation partagée à l'avance (critères : CA, satisfaction client, travail d'équipe). Les deux parties signent un compte rendu. Amina demande une formation négociation pour monter en compétence.",
    consigne: "Explique le rôle de l'entretien professionnel, le risque de subjectivité et l'intérêt d'une grille d'évaluation.",
    questions: [
  ...
  },
  {
    ...
    xp: 140,
    minChars: 150,
    support: "La boulangerie industrielle « Pain Quotidien » suit chaque mois : nombre de baguettes produites, taux de rebuts, heures travaillées par équipe, effectif présent. En janvier : 980 000 baguettes, 4 200 heures, 95 salariés. Février : 1 050 000 baguettes, 4 100 heures, 94 salariés. Le directeur utilise ces indicateurs pour l'évaluation collective de l'atelier.",
    supportTables: [
      { title: "Production atelier — Pain Quotidien", columns: ["Mois", "Baguettes", "Heures", "Effectif"], rows: [["Janvier", "980 000", "4 200", "95"], ["Février", "1 050 000", "4 100", "94"]] },
    ],    consigne: "Distingue indicateurs d'activité et de productivité. Calcule productivité horaire et par tête pour février.",
    questions: [
  ...
  },
  {
    ...
    xp: 180,
    minChars: 160,
    support: "Camille, assistante administrative, perçoit un salaire de base de 2 200 €, une prime d'ancienneté de 80 € et 120 € d'heures supplémentaires. Cotisations salariales : 22 % du brut. Prélèvement à la source : 3 %. Le manuel rappelle : salaire brut = base + compléments ; net après prélèvement = brut ? cotisations ? impôt source ; employeur verse aussi des cotisations patronales.",
    consigne: "Calcule le salaire brut puis le net après prélèvement à la source. Explique la différence brut/net et cite les composantes de la rémunération.",
    questions: [
  ...
  },
  {
    ...
    xp: 190,
    minChars: 180,
    support: "Dassault Aviation rémunère ses techniciens avec salaire de base, prime de risque (atelier), prime de rendement si objectifs qualité atteints, tickets restaurant (avantage en nature), véhicule de fonction pour les inspecteurs (avantage en nature), indemnité de transport non imposable dans certaines limites. La direction communique sur l'équité interne : grille transparente liant primes aux indicateurs d'activité.",
    consigne: "Classe chaque élément de rémunération (salaire, prime, avantage en nature, indemnité). Explique l'équité interne.",
    questions: [
  ...
  },
  {
    ...
    xp: 210,
    minChars: 180,
    support: "L'entreprise de plus de 50 salariés « TechFlow » (120 salariés) verse une participation légale de 400 000 € répartie au prorata des salaires. Elle propose aussi un accord d'intéressement lié au résultat d'exploitation : si ROE > 8 %, bonus collectif. En 2024, ROE = 9 % : chaque salarié reçoit 1 200 €. Le CSE valide l'accord. Objectif : fédérer autour de la performance collective.",
    consigne: "Distingue participation et intéressement. Explique la rémunération collective et la fidélisation.",
    questions: [
  ...
  },
  {
    ...
    xp: 230,
    minChars: 200,
    support: "Un ingénieur chez Safran compare son salaire à celui d'un homologue chez Thales (équité externe) et à celui d'un technicien du même service (équité interne). Il estime un écart de 8 % avec Thales et 25 % avec le technicien. Le DRH explique : grille de métiers, convention collective, prime ancienneté. Une enquête salariale sectorielle est lancée pour éviter les départs vers la concurrence.",
    consigne: "Définis équité interne et équité externe. Analyse la situation de l'ingénieur.",
    questions: [
  ...
  },
  {
    ...
    xp: 260,
    minChars: 220,
    support: "Chez L'Oréal, la prime au mérite suit l'entretien annuel : note A = 15 % de prime, B = 8 %, C = 0 %. Un salarié noté B accepte car la grille était connue. Un salarié noté C démissionne. Le manager du site Brest améliore les entretiens en fixant des objectifs SMART en début d'année. Motivation globale en hausse selon enquête interne (+12 points).",
    consigne: "Explique le lien entre évaluation, rétribution (prime au mérite) et motivation. Montre effets positifs et négatifs.",
    questions: [
  ...
  },
  {
    ...
    xp: 280,
    minChars: 200,
    support: "L'usine « TextilPro » enregistre 1 240 jours d'absence pour maladie sur une période où le temps théorique de travail est de 18 500 jours. Le DRH calcule le taux d'absentéisme. Les causes identifiées : cadence élevée, climat social tendu. Actions : ergonomie, formation managers. Objectif : passer sous 5 %.",
    supportTables: [
      { title: "Absentéisme TextilPro", columns: ["Indicateur", "Valeur"], rows: [["Jours d'absence", "1 240"], ["Jours théoriques travaillés", "18 500"]] },
    ],    consigne: "Calcule le taux d'absentéisme avec la formule du cours. Interprète le résultat et les coûts pour l'organisation.",
    questions: [
  ...
  },
  {
    ...
    xp: 360,
    minChars: 240,
    support: "Start-up « GreenApps » : effectif 01/01/N = 80 ; départs en N = 14 ; arrivées = 18. Le DRH estime qu'un recrutement raté coûte jusqu'à 100 000 € (temps RH, annonces, tests). Turn-over élevé entraîne fuite de compétences et baisse productivité. La direction lie une revalorisation des salaires juniors à une baisse des départs.",
    supportTables: [
      { title: "Effectifs GreenApps — année N", columns: ["Indicateur", "Valeur"], rows: [["Effectif au 01/01/N", "80"], ["Départs", "14"], ["Arrivées", "18"]] },
    ],    consigne: "Calcule le taux de rotation du personnel. Explique pourquoi le turn-over est un coût pour l'organisation au-delà de la rémunération.",
    questions: [
  ...
  },
  {
    ...
    xp: 560,
    minChars: 400,
    support: "Danone combine salaire de base (convention agroalimentaire), primes de rendement liées aux objectifs CO? et CA, participation légale, intéressement sur marge, tickets restaurant, télétravail deux jours. L'entretien professionnel fixe trois objectifs notés. En 2024, taux d'absentéisme 4,2 %, turn-over 9 %. Un site voit une grève sur primes jugées opaques ; la direction publie la grille et forme les managers. Équité externe : enquête salariale monde vs Nestlé/Unilever.",
    consigne: "Rédige une analyse type bac : évaluation, composantes de rétribution, équité, indicateurs RH, lien motivation. Propose des recommandations.",
    questions: [
  ...
  },
  {
    ...
    xp: 620,
    minChars: 450,
    support: "Hôpital privé « Santé+ » : 450 salariés, absentéisme 11 %, turn-over infirmières 24 %. Causes : sous-effectif, primes nuit faibles, évaluation perçue comme injuste. Projet : prime de risque +15 %, entretiens avec grille, auto-évaluation, participation aux gains si indicateurs qualité atteints. Coût recrutement infirmière : 25 000 €. Simulation : baisse absentéisme à 7 % économiserait 180 000 €/an. Négociation avec CSE en cours.",
    supportTables: [
      { title: "Indicateurs Santé+", columns: ["Indicateur", "Valeur actuelle", "Cible"], rows: [["Absentéisme", "11 %", "7 %"], ["Turn-over infirmières", "24 %", "—"], ["Coût recrutement / poste", "25 000 €", "—"], ["Économie potentielle", "—", "180 000 €/an"]] },
    ],    consigne: "Construis un tableau de bord RH et un argumentaire direction : évaluation, rétribution, coûts du travail, motivation. Chiffre le ROI des mesures proposées.",
    questions: [
