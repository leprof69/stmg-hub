                ...
                <Fragment key={eleve.id}>
                  <tr
                    style={{
                      ...
                      background: open ? "#F8FAFC" : eleve.platformIntegrity?.xpSuspended ? "#FFF1F2" : "white",
                      cursor: "pointer",
                    }}
                      ...
                      <td colSpan={10} style={{ padding: 0, background: "#F8FAFC", borderTop: "1px dashed #CBD5E1" }}>
                        <div style={{ padding: "14px 16px 16px" }} onClick={(e) => e.stopPropagation()}>
                          ...
                          {eleve.sdgnRows?.length ? (
                            <div style={{ marginBottom: 12 }}>
                              ...
                              >
                                {sdgnExpanded[eleve.id]
                                  ? "\u25bc Masquer SDGN"
                                  : `\u25b6 SDGN : ${eleve.sdgnRows.length} exercice(s)`}
                              </button>
                              {sdgnExpanded[eleve.id] ? (
                                  ...
                                  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.74rem" }}>
                                    <thead>
                                      <tr style={{ background: "#F5F3FF", color: "#4C1D95" }}>
                                        ...
                                        <th style={{ padding: 8 }}>Jetons</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      {eleve.sdgnRows.map((row) => (
                                        <tr key={row.exerciseId} style={{ borderTop: "1px solid #EDE9FE" }}>
                                          <td style={{ padding: 8 }}>{row.chapter.replace(/^SDGN\s+/i, "")}</td>
                            ...
                            <p style={{ margin: "0 0 12px", color: "#94A3B8", fontSize: "0.8rem" }}>{"Aucune mission SDGN."}</p>
                          )}
